...
describe('Checkout: Your info', () => {
  ...
  it('should show an error when the first name has not been entered', () => {
    ...
    expect(CheckoutPageOne.getErrorMessage()).toContain('First Name is required', 'The error message is not as expected');
  });
  ...
  it('should show an error when the last name has not been entered', () => {
    ...
    expect(CheckoutPageOne.getErrorMessage()).toContain('Last Name is required', 'The error message is not as expected');
  });
  ...
  it('should show an error when the postal code has not been entered', () => {
    ...
    expect(CheckoutPageOne.getErrorMessage()).toContain('Postal Code is required', 'The error message is not as expected');
  });
});
